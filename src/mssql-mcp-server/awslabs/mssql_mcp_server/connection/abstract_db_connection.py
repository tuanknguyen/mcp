...
"""Abstract database connection interface for mssql MCP Server."""
...
class AbstractDBConnection(ABC):
    ...
    async def execute_query(
        ...
        Args:
            ...
            parameters: Optional parameters for the query. Either a list of
                Data API-style dicts (with 'name' and 'value' keys) or a plain
                tuple of positional values for native pymssql binding.
